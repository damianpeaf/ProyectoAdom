...
if (isset($_POST["btnAceptar"])) {
    ...
    if (mysqli_query($cn, "INSERT into usuario values(null, '{$correo}', '{$password}', {$tipoUsuario})")) {
        echo "<script>
...
<body>
    ...
    <div class="bd-example">
        ...
        <form action="" name="formAceptar" method="post">
            ...
            <center>
                <button type="submit" name="btnAceptar" class="btn btn-primary">Registrar</button>
            </center>
